...
| コマンド                                                                             | 説明                                                                                              |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| `npx zenn new:article`                                                               | Markdown ファイルを作成します。作成されたファイルには記事の設定（Front Matter）が含まれています。 |
...
| `price`     | 本の価格を指定します（200〜5000 の間で 100 円単位）。 |
| `chapters`  | チャプターの並び順を配列で指定します。                |
| `toc_depth` | 目次の深さを指定します（0〜3 の範囲）。               |
